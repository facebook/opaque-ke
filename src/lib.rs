...
//! [`Identity`](ksf::Identity), is selected only to ensure that the tests
//! execute quickly. A real application should use an actual key stretching
//! function, such as `Argon2`, which can be enabled through the `argon2`
//! feature. See more details in the [features](#features) section.
//!
//! ## Setup
